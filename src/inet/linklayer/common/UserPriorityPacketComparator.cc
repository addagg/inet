...
#include "inet/linklayer/common/UserPriorityPacketComparator.h"
#include "inet/linklayer/common/UserPriorityTag_m.h"

namespace inet {

Register_Class(UserPriorityPacketComparator);
...
int UserPriorityPacketComparator::comparePackets(Packet *a, Packet *b) const
{
    return comparePacketsByUserPriority(a, b);
}

inet::queue::PacketComparatorFunction UserPriorityPacketComparator::getComparatorFunction() const
{
    return &comparePacketsByUserPriority;
}
