...
Register_Function("compareMgmtOverData", compareMgmtOverData);
...
Register_Function("compareMgmtOverMulticastOverUnicast", compareMgmtOverMulticastOverUnicast);
...
Register_Function("classifyMgmtOverData", classifyMgmtOverData);
...
Register_Function("classifyMgmtOverMulticastOverUnicast", classifyMgmtOverMulticastOverUnicast);
